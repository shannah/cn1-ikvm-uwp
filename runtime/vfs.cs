...
namespace IKVM.Internal
{
	static class VirtualFileSystem
	{
		...
		private sealed class VfsAssembliesDirectory : VfsDirectory
		{
			...
			{
#if WINRT
                throw new NotImplementedException("VfsAssembliesDirectory");
#else
 				throw new NotImplementedException("VfsAssembliesDirectory");
			...
			{
#if WINRT
                throw new NotImplementedException("IsLoadContext");
#else
                throw new NotImplementedException("IsLoadContext");
...
//                  return false;
		...
		private sealed class VfsCacertsEntry : VfsFile
		{
			...
			{
#if WINRT
                throw new NotImplementedException("Populate");
#else
                if (buf == null)
                {
