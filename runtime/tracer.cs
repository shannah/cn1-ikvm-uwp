	...
	public static class Tracer
	{
...
#else
        public readonly static object Compiler = new object();
        public readonly static object FxBug = new object();
        public readonly static object ClassLoading = new object();
        public readonly static object Verifier = new object();

        public readonly static object Runtime = new object();
#endif
		...
		private static void Init()
		{
            ...
            try
            {
                ...
                string trace = null;// EUGENE ConfigurationManager.AppSettings["Traced Methods"];
                if (trace != null)
                {
...
#else 		
        [Conditional("TRACE")]
		public static void Info(object traceSwitch, string message, params object[] p)
        {
        }
#endif
...
#else
        [Conditional("TRACE")]
		public static void Warning(object traceSwitch, string message, params object[] p)
        {}
#endif
...
#else
         [Conditional("TRACE")]
		public static void Error(object traceSwitch, string message, params object[] p)
        {}
#endif
    }
}
