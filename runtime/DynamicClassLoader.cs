...
//		[System.Security.SecuritySafeCritical]
...
#if WINRT
            throw new NotImplementedException(); // EUGENE
#else
		...
		{
#if WINRT
            throw new NotImplementedException("CreateModuleBuilder");
#else
            ...
            else
            {
                access = AssemblyBuilderAccess.Run;
            			...
            			{
            				attribs.Add(new CustomAttributeBuilder(typeof(System.Security.SecurityTransparentAttribute).GetConstructor(_Type.EmptyTypes), new object[0]));
            			}
#endif
           ...
           // assemblyBuilder.SetCustomAttribute(debugAttr);
            ...
            moduleBuilder.SetCustomAttribute(new CustomAttributeBuilder(typeof(IKVM.Attributes.JavaModuleAttribute).GetConstructor(_Type.EmptyTypes), new object[0]));
            return moduleBuilder;
#endif
        }
