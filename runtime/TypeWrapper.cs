...
namespace WinRT.Reflection.Stub
{
    ...
    class _T
    {
        ...
        public MethodInfo GetMethod(string name, Type[] types, object[] modifiers)
        {
            throw new NotImplementedException();
        }
    ...
    struct OpCode
    {
        ...
        public static bool operator ==(OpCode a, OpCode b) { return false; }
    ...
    class OpCodes
    {
        ...
        //
        // Summary:
        //     Adds two integers, performs an overflow check, and pushes the result onto the
        //     evaluation stack.
    ...
    class TypeBuilder : _T
    {
        ...
        public void AddInterfaceImplementation(object o) { }
        public void SetCustomAttribute(object o) { }
        public void SetCustomAttribute(object o, object e) { }
        public void DefineField(object o) { }
    }

    class EventBuilder : _T
    {
    }

    class ConstructorBuilder : _T
    {
    }

    class ModuleBuilder : _T
    {
        public void SetCustomAttribute(object o) { }
        public void SetCustomAttribute(object o, object e) { }
    }

    class FieldBuilder : _T
    {
        public void SetCustomAttribute(object o) { }
        public void SetCustomAttribute(object o, object e) { }
    }

    class CustomAttributeBuilder : _T
    {
        public CustomAttributeBuilder(object o, object c)
        {
    ...
    class ParameterBuilder : _T
    {
        public void SetCustomAttribute(object o) { }
        public void SetCustomAttribute(object o, object e) { }
    }

    class AssemblyBuilder : _T
    {
        public void SetCustomAttribute(object o) { }
        public void SetCustomAttribute(object o, object e) { }
    }

    class PropertyBuilder : _T
    {
        public void SetCustomAttribute(object o) { }
        public void SetCustomAttribute(object o, object e) { }
    }

    class LocalBuilder : _T
    {
...
namespace IKVM.Internal
{
	...
	{
#if WINRT
        internal static readonly string CLINIT = "<clinit>";
		internal static readonly string INIT = "<init>";
		internal static readonly string SIG_VOID = "()V";
		internal static readonly string FINALIZE = "finalize";
		internal static readonly string CLONE = "clone";
#else
...
#else
           // return mod.GetCustomAttributes(typeofJavaModuleAttribute, false);
            return RuntimeReflectionHelper.GetCustomAttributes(mod, typeofJavaModuleAttribute, false);
#endif
#else
...
#if !STATIC_COMPILER && !STUB_GENERATOR
#if WINRT
        internal static bool MakeDeclSecurity(Type type, object annotation, out object action, out object permSet)
#else
	...
	internal abstract class TypeWrapper
	{
		...
		internal static TypeWrapper FromClass(java.lang.Class clazz)
		{
			...
			return null;
#else
           // RuntimeReflectionHelper.Instance.Mark("FROM CLASS");
			...
			if(tw == null)
			{
				...
				if (type == null)
				{
                   // RuntimeReflectionHelper.Instance.Mark("Start");
                    ResolvePrimitiveTypeWrapperClasses();
                   // RuntimeReflectionHelper.Instance.Mark("Resolved");
		...
		{
#if WINRT
            throw new NotImplementedException("GetSerializationConstructor");
#else
	...
	class CompiledTypeWrapper : TypeWrapper
	{
...
#else
#if WINRT
            RuntimeReflectionHelper.Instance.Mark("IsCallerID");
            // EUGENE
#endif
            return type.FullName == "ikvm.internal.CallerID";
...
#else
            return RuntimeReflectionHelper.SortFieldByToken(field1, field2);
#endif
        }
		...
		private static TypeWrapper GetPropertyTypeWrapper(PropertyInfo property)
		{
            ...
            return ClassLoaderWrapper.GetWrapperFromType(property.PropertyType);
#else
				return TypeWrapperFromModOpt(property.GetOptionalCustomModifiers())
				?? ClassLoaderWrapper.GetWrapperFromType(property.PropertyType);
#endif
		...
		internal static TypeWrapper GetFieldTypeWrapper(FieldInfo field)
		{
            ...
            return ClassLoaderWrapper.GetWrapperFromType(field.FieldType);
#else
			return TypeWrapperFromModOpt(field.GetOptionalCustomModifiers())
				?? ClassLoaderWrapper.GetWrapperFromType(field.FieldType);
#endif
		...
		{
#if WINRT
            TypeWrapper tw = null;//TypeWrapperFromModOpt(param.GetOptionalCustomModifiers());
#else
...
namespace IKVM.Runtime
{
    ...
    public abstract class NativeThreadHelper
    {
        ...
        public static void setInstance(NativeThreadHelper inst) 
            
        {
                _instance = inst;
        }

        public static NativeThreadHelper getInstance()
        {
            return _instance;
        }

        public abstract NativeThread NewThread();
        public abstract NativeThread CurrentThread
        {
            get;
        }
        public abstract void Sleep(int ms);
        public abstract bool QueueUserWorkItem(NativeWaitCallback callback);
        public abstract bool QueueUserWorkItem(NativeWaitCallbackWithArg callback, object obj);
    ...
    public abstract class NativeThread
    {
        ...
        public abstract void init(NativeThreadStart start);

        public abstract void Start();



        public abstract bool Join(int millisecondsTimeout);
        ...
        public abstract int ThreadState
        {
            get;
