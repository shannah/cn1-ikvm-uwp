...
namespace IKVM.Internal
{
	...
	class ClassLoaderWrapper
	{
...
#if WINRT
            Assembly coreAssembly = RuntimeReflectionHelper.Instance.GetCoreAssembly();
#else
...
#else
                RemappedClassAttribute[] remapped = RuntimeReflectionHelper.Instance.GetRemappedClasses(coreAssembly);
#endif
        ...
        internal TypeWrapper LoadClassByDottedName(string name)
		{
            ...
            {
                Debug.WriteLine(nie);
                Debug.WriteLine("Not implemented exception loading " + name);
            }
