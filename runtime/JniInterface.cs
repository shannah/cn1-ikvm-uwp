...
namespace IKVM.Runtime
{
	...
	public unsafe sealed class JNI
	{
		...
		public struct Frame
		{
            ...
            {					
#if true
				RuntimeReflectionHelper.Instance.Mark("1");
                ClassLoaderWrapper loader = ClassLoaderWrapper.FromCallerID(callerID);
				RuntimeReflectionHelper.Instance.Mark(loader);
...
#else
            throw new NotImplementedException("will");
#endif
            }
	...
	unsafe struct JNIEnv
	{
		...
		{
			throw new NotImplementedException("FatalError");
