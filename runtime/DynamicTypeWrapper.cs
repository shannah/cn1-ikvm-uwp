...
#endif
    {
        ...
        private sealed class JavaTypeImpl : DynamicImpl
        {
            ...
            internal override FieldInfo LinkField(FieldWrapper fw)
            {
				...
				{
#if WINRT
                    throw new NotImplementedException("LinkField");
#else
        ...
        internal sealed class FinishContext
        {
...
#if WINRT
                    throw new NotImplementedException("DynamicTypeWrapper.GetFieldList");
#else
...
#else
                private static readonly MethodInfo writeLine = null;
#endif
			...
			private void EmitCallerIDStub(MethodWrapper mw, string[] parameterNames)
			{
                ...
                ilgen.Emit(OpCodes.Ldnull);
				MethodWrapper callerID = CoreClasses.ikvm.@internal.CallerID.Wrapper.GetMethodWrapper("create", "(Lcli.System.Reflection.MethodBase;)Likvm.internal.CallerID;", false);
				callerID.Link();
