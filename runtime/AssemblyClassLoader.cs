...
namespace IKVM.Internal
{
    ...
    public class RuntimeReflectionHelper
    {
        static private RuntimeReflectionHelper _instance = new RuntimeReflectionHelper();

        public static RuntimeReflectionHelper Instance {
        ...
        public virtual Type GetModuleType(Module m, string name)
        {
            throw new NotImplementedException();
        }

        public virtual RemappedClassAttribute[] GetRemappedClasses(Assembly assambly)
        {
            return null;
        }

        public virtual Module GetTypeModule(Type type)
        {
            throw new NotImplementedException();
        }

        public virtual Assembly GetCoreAssembly()
        {
            throw new NotImplementedException();
        }
        ...
        public static ConstructorInfo GetConstructor(Type[] types)
        {
            throw new NotImplementedException();
        }
        ...
        public static ConstructorInfo GetConstructor(Type type, BindingFlags bindingAttr, object binder, CallingConventions callConvention, Type[] types, object[] modifiers)
        {
            throw new NotImplementedException();
        }
        ...
        {
            return _instance.GetConstructorImpl(type, types);
            //return type.GetConstructor(;
        }

        public virtual object[] GetCustomAttributesImpl(Module mod, Type attributeType, bool inherit)
        {
            throw new NotImplementedException();        
        }

        public virtual int SortFieldByTokenImpl(FieldInfo field1, FieldInfo field2)
        {
#if !WINRT
        ...
        public static object[] GetCustomAttributes(Module mod, Type attributeType, bool inherit)
        {            
            return _instance.GetCustomAttributesImpl(mod, attributeType, inherit);
        }

        public static int SortFieldByToken(FieldInfo field1, FieldInfo field2)
        {
            return _instance.SortFieldByTokenImpl(field1, field2);
        }

        public virtual void Mark(object obj) { }
    }
	...
	class AssemblyClassLoader : ClassLoaderWrapper
	{
		...
		private sealed class AssemblyLoader
		{
...
#if WINRT
                modules = RuntimeReflectionHelper.Instance.GetModules(assembly);//.GetModules(false);
#else
            ...
            private Type GetType(Module mod, string name)
			{
                ...
                {
#if WINRT
                    return RuntimeReflectionHelper.Instance.GetModuleType(mod, name);
#else
            ...
            {
#if WINRT
                Module mod = RuntimeReflectionHelper.Instance.GetTypeModule(type);
#else
		...
		{
#if WINRT
              RuntimeReflectionHelper.Instance.Mark("AssemblyClassLoader");
            RuntimeReflectionHelper.Instance.Mark(assembly);
#endif
        }
...
#if WINRT
            RuntimeReflectionHelper.Instance.Mark("AssemblyClassLoader fixedReferences initialized");
            RuntimeReflectionHelper.Instance.Mark(assembly);
#endif
        }
		...
		{
#if WINRT
            RuntimeReflectionHelper.Instance.Mark("In DoInitializeExportes");
            throw new NotImplementedException();
#else
            lock (this)
            {
		...
		protected override TypeWrapper LoadClassImpl(string name, bool throwClassNotFoundException)
		{
            ...
            {
#if WINRT
                RuntimeReflectionHelper.Instance.Mark("Not Implemented Exception thrown while loading "+name);
                RuntimeReflectionHelper.Instance.Mark(name +"In AssemblyClassLoader.LoadClassImpl");    
#endif                
            }
            ...
            Assembly assembly = assemblyLoader.Assembly;
            {
                if (customClassLoaderClass != null)
                {
                    try
                    {
                        ...
                        ConstructorInfo customClassLoaderCtor =
    customClassLoaderClass.GetConstructor(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic, null, new Type[] { typeof(Assembly) }, null);
...
//#else
//                        ConstructorInfo customClassLoaderCtor =
//                            RuntimeReflectionHelper.GetConstructor(customClassLoaderClass, BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic, null, new Type[] { typeof(Assembly) }, null);
//#endif
		...
		{
            throw new NotImplementedException("GetUninitializedObject");
...
#else
            :base (RuntimeReflectionHelper.Instance.GetCoreAssembly(), null)
#endif
        {
        }
