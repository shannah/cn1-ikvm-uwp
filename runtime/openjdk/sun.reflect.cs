...
static class Java_sun_reflect_ReflectionFactory
{
...
#if !WINRT
        private static readonly MethodInfo byteValue = typeof(java.lang.Byte).GetMethod("byteValue", _Type.EmptyTypes);
		private static readonly MethodInfo booleanValue = typeof(java.lang.Boolean).GetMethod("booleanValue", _Type.EmptyTypes);
		private static readonly MethodInfo charValue = typeof(java.lang.Character).GetMethod("charValue", _Type.EmptyTypes);
		private static readonly MethodInfo shortValue = typeof(java.lang.Short).GetMethod("shortValue", _Type.EmptyTypes);
		private static readonly MethodInfo intValue = typeof(java.lang.Integer).GetMethod("intValue", _Type.EmptyTypes);
		private static readonly MethodInfo floatValue = typeof(java.lang.Float).GetMethod("floatValue", _Type.EmptyTypes);
		private static readonly MethodInfo longValue = typeof(java.lang.Long).GetMethod("longValue", _Type.EmptyTypes);
		private static readonly MethodInfo doubleValue = typeof(java.lang.Double).GetMethod("doubleValue", _Type.EmptyTypes);
#else
        private static readonly MethodInfo byteValue = typeof(java.lang.Byte).GetMethod("byteValue", _Type.EmptyTypes);
		private static readonly MethodInfo booleanValue = typeof(java.lang.Boolean).GetMethod("booleanValue", _Type.EmptyTypes);
		private static readonly MethodInfo charValue = typeof(java.lang.Character).GetMethod("charValue", _Type.EmptyTypes);
	...
	private sealed class FastSerializationConstructorAccessorImpl : sun.reflect.ConstructorAccessor
	{
        ...
        private static readonly MethodInfo GetUninitializedObjectMethod = null;//typeof(FormatterServices).GetMethod("GetUninitializedObject", new Type[] { typeof(Type) });
...
#if WINRT
        //EUGENE
        RuntimeReflectionHelper.Instance.Mark("I Got Here");
        MethodAccessorImpl res = new MethodAccessorImpl(mw);
        RuntimeReflectionHelper.Instance.Mark("I Got Here 1");
        return res;
#endif
#if !NO_REF_EMIT
        if (!mw.IsDynamicOnly)
