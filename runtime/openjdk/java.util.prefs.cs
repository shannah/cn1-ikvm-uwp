...
static class Java_java_util_prefs_WindowsPreferences
{
	...
	public static int[] WindowsRegOpenKey(int hKey, byte[] subKey, int securityMask)
	{
        ...
        throw new NotImplementedException("WindowsRegOpenKey");
	...
	{
        throw new NotImplementedException("WindowsRegCloseKey");        
		//keys[hKey - 1].Close();
		//lock (keys)
		//{
		//	keys[hKey - 1] = null;
	...
	{
        throw new NotImplementedException("WindowsRegCreateKeyEx");
        //Microsoft.Win32.RegistryKey resultKey = null;
        //int error = 0;
        //int disposition = -1;
        //try
	...
	{
        throw new NotImplementedException("WindowsRegDeleteKey");
        //try
        //{
	...
	{
        throw new NotImplementedException("WindowsRegFlushKey");
        //MapKey(hKey).Flush();
        //return 0;
	}
	...
	public static byte[] WindowsRegQueryValueEx(int hKey, byte[] valueName)
	{
        ...
        throw new NotImplementedException("WindowsRegQueryValueEx");
        //try
        //{
	...
	{
        throw new NotImplementedException("WindowsRegSetValueEx");
	...
	{
        throw new NotImplementedException("WindowsRegDeleteValue");
        //try
        //{
	...
	{
        throw new NotImplementedException("WindowsRegQueryInfoKey");
    ...
    {
        throw new NotImplementedException("WindowsRegEnumKeyEx");
        //try
        //{
	...
	{
        throw new NotImplementedException("WindowsRegEnumValue");
        //try
        //{
