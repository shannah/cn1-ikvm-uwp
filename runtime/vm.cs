	...
	static class JVM
	{
		...
		internal static bool EmitSymbols
		{
			get
			{
				...
				{
					int state;
                    string debug = null;// EUGENE System.Configuration.ConfigurationManager.AppSettings["ikvm-emit-symbols"];
					if (debug == null)
					{
		...
		internal static bool IsUnix
		{
			...
			{
#if WINRT
                return false;//  Environment.OSVersion.Platform == PlatformID.Unix;
#else
		...
		{
#if WINRT
            throw new NotImplementedException("CriticalFailure");
#else
			 throw new NotImplementedException("CriticalFailure");
//              try
//              {
