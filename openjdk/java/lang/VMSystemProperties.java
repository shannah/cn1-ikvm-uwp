...
final class VMSystemProperties
{
    ...
    public static void initProperties(Properties p)
    {
		...
		p.setProperty("user.language", "en");
        p.setProperty("user.country", "US");
	...
	// p.setProperty("user.timezone", "");	// p.setProperty("sun.os.patch.level", cli.System.Environment.get_OSVersion().get_ServicePack());
