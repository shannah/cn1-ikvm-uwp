...
//     }
//     
    private InteropObjectOutputStream(Object info, Object obj, Class cl, ObjectStreamClass desc) throws IOException
    {
        super(null);
        dos = null;//new ObjectDataOutputStream(info);
...
//     }
    ...
    private static final class ObjectDataOutputStream extends DataOutputStream
    {
      ...
      //  private final SerializationInfo info;
        ...
        ObjectDataOutputStream(Object info)
        {
            super(null);
            // out = this;
            // this.info = info;
